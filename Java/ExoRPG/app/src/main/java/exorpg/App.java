...
public class App {
    ...
    public static void main(String[] args) {
        ...
        Arme arme2 = new Arme("Hache de toto");
        arme2.setDegats(40);
        arme2.setCritique(0.1f);
        arme2.setPoids(2);
        arme2.save();
        
        try {
            
            String sql = "INSERT INTO armes (nom, degats, critique, poids) VALUES(?, ?, ?, ?)";
            
            PreparedStatement pstmt = DBManager.conn.prepareStatement(sql);
            pstmt.setString(1, "Epee neuve");
            pstmt.setInt(2, 30);
            ...
            pstmt.setString(1, "Epee diamant");
            pstmt.execute();
